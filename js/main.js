...
const kitten1Raza = "Siamés"
const kitten2Raza = "Sphynx"
const kitten3Raza = "Maine Coon"


const kittenOne = `<li class="card">
                  
                        <img class="card_img" src="${kitten1Image}" alt="siames-cat"/>
                        <h3 class="card_title">${kitten1Name.toUpperCase()}</h3>
                        <h4 class="card_race">${kitten1Raza}</h4>
                        <p class="card_description">${kittenDescription1}</p>
                    </li>`
const kittenTwo = `<li class="card">
                  
                        <img class="card_img" src="${kitten2Image}" alt="siames-cat"/>
                        <h3 class="card_title">${kitten2Name.toUpperCase()}</h3>
                        <h4 class="card_race">${kitten2Raza}</h4>
                        <p class="card_description">${kittenDescription2}</p>
                    </li>`

const kittenThree = `<li class="card">
                  
                        <img class="card_img" src="${kitten3Image}" alt="siames-cat"/>
                        <h3 class="card_title">${kitten3Name.toUpperCase()}</h3>
                        <h4 class="card_race">${kitten3Raza}</h4>
